...
//        dbHandler.addRecord(new Record("Won lottery", "", 100.00, "Income", currentDate(), currentTime(), 1));
//        dbHandler.addRecord(new Record("Salary", "", 4000.00, "Salary", currentDate(), currentTime(), 1));
//        dbHandler.addRecord(new Record("Bonus", "", 2000.00, "Income", currentDate(), currentTime(), 1));
//
